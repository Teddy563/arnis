...
/// custom build is distinguishable from an official release - the 1.9.2
/// stale-bundle incident needed byte-size + version-grep forensics that this
/// makes a one-liner. Falls back to "unknown" when git is unavailable

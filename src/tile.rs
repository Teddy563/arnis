...
/// Only the test-side brute_force reference implementation still walks members
/// this way; the real assignment path memoizes member AABBs instead.
#[cfg(test)]
...
/// Test-side only, like `relation_intersects_bounds` above.
#[cfg(test)]
